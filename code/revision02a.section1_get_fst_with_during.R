...
L_left <- L_snames_joined[which(!L_snames_joined %in% L_snames_1p)]
L_snames_2p <- sample(L_left, length(L_snames_2),replace = F)
...
save.image("./perms/permuted_ITERATION/fst_allsites.with_during.RData")
