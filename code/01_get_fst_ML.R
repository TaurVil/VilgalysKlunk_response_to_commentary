# This file starts with the genotype likelihood files copied from our original work (available at GitHub/TarVil/VilgalysKlunk_yersinia_pestis/part1_aDNA/DATA/)
...
plot(info$alternate.ML ~ info$alternate.GL, col=rgb(0,0,1,.3), xlab="Mean Genotype Likelihood", ylab="Maximum Likelihood"); abline(a=0,b=1,col='red', lwd=5)
summary(lm(info$alternate.ML ~ info$alternate.GL))
